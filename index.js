...
function handleLocation(message, replyToken) {
  return client.replyMessage(
    ...
    {
      type: 'location',
      // it will throw an error if the title is null or empty string
      title: message.title || 'empty', 
...
function handleSticker(message, replyToken) {
  ...
  // if sticker from user is not in the list of allowed stickers then it can't be used
